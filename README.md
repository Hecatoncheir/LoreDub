...
поток**, **Whisper**, **Перевод**, **Голос** и **Поток**, соединённые
связями. Холст двигается мышью по пустому месту, колесо меняет масштаб, а при
...
отдельно, поэтому разойтись им не с чем. Пока идёт сеанс, маршрут и модели
закреплены до остановки.

Кнопка с человечком выносит на схему карточку персонажа. Протянутая от одного
персонажа к другому связь говорит, чьим голосом кого читать — та же замена,
что стоит в карточке на экране **Персонажи**: она действует во всех играх, а
выбор в **Голосах сцены** перебивает её для текущей игры. Связь снимается
кнопкой на самой линии, и персонаж снова читается своим голосом; двух
персонажей, которые читали бы друг друга, соединить нельзя. Замену можно
менять и во время сеанса — следующая реплика уже звучит иначе. Схема помнит,
где стоят ноды, а стрелки отмены и возврата откатывают и маршрут, и замену
голоса, и расположение.
...
запись, экспорт, удаление. Там же кнопка **Озвучивать голосом другого
персонажа**: выберите в ней любого из своих — и этот персонаж будет говорить
