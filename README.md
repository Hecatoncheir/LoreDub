...
появляется строка с причиной. Две готовые раскладки — **Речь из игры** и
...
Настройки разбиты на четыре группы. **Язык и источник** — язык интерфейса
(русский или английский, меняется сразу), источник текста (звук или субтитры) и
рамка субтитров. **Озвучка** — громкость оригинала во время перевода,
скорость и выбор голоса. **Клавиши и вычисления** — горячие клавиши,
потоки CPU и вычислительное устройство. Четвёртая, **Дополнительно**, сложена
и раскрывается нажатием на заголовок: путь к Python, proxy для загрузок и
каталог моделей меняют, когда что-то не работает, а не во время игры.
...
**1. Включите режим.** **Настройки → Источник текста → Субтитры с экрана.**
...
<p align="center">
  <img src="docs/screenshots/ocr-settings-ru.png" width="900" alt="Настройки: режим «Субтитры с экрана» и рамка на уменьшенном экране монитора">
</p>
