...
(русский или английский, меняется сразу) и горячие клавиши. **Озвучка** —
...
показывает, куда попала каждая ступень. Четвёртая группа, **Дополнительно**,
сложена и раскрывается нажатием на заголовок: путь к Python, proxy для
загрузок и каталог моделей меняют, когда что-то не работает, а не во время
игры.
