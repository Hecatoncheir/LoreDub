...
Настройки разбиты на четыре группы. **Интерфейс** — язык интерфейса
(русский или английский, меняется сразу). **Озвучка** — громкость оригинала
во время перевода, скорость и выбор голоса. **Клавиши и вычисления** — горячие клавиши,
...
**1. Откройте «Экран» и выберите игру.** Читается окно выбранного процесса.
...
**3. Запустите чтение.** Нажмите **Запустить** и переключитесь в игру. Текст
читается, только пока игра — активное окно, поэтому ни окно LoreDub, ни
браузер поверх игры за субтитры не сойдут.
