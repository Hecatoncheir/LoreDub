...
Режим **Субтитры + OCR** работает с оконными и безрамочными играми. Где искать
текст, задают в настройках: на уменьшенном экране в форме монитора мышью
обводят рамку вокруг места, где игра пишет субтитры, а затем её двигают и
тянут за углы и стороны. Рамка хранится в долях окна игры, поэтому подходит к
любому разрешению; по умолчанию это нижние 45% окна. В Windows должен быть
