...
- **Дописанная реплика озвучивается только в новой части.** Если начало новой
  строки слово в слово повторяет хотя бы половину предыдущей — окно диалога
  допечатало фразу или добавило второе предложение, — озвучиваются только слова
  с места, где тексты расходятся. Иначе это другая реплика, и она звучит
  целиком. Текст, полностью совпадающий с предыдущим, не озвучивается вовсе —
