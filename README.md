...
Замер на RTX 3080 Ti (15 с звука, `ggml-base`, 12 потоков): CPU 2.9–4.0 с против
1.7–1.8 с на CUDA. Первый запуск после включения CUDA занял 23 с — драйвер
собирает кеш ядер; это разовая плата, дальше время стабильное.
