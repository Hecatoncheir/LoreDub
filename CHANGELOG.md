...
- Появился экран «Схема» — второй в списке, сразу за «Эфиром». Конвейер нарисован нодами:
  «Оригинальный поток», «Whisper», «Перевод», «Голос» и «Поток», соединённые связями, которые
  тянутся от кружка к кружку по точечному холсту; холст двигается мышью, колесо меняет масштаб.
