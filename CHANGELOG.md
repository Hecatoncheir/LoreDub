...
- Ползунок громкости оригинала на «Схеме» и в настройках стал одним и тем же — те же пределы и тот
  же шаг в 2%. Раньше на схеме он доходил до 100% шагом в 5%, и выставленное там число в настройках
  было не повторить.
- Появилась настройка «Приглушать только под перевод», по умолчанию выключенная. С ней игра звучит
  в полную громкость, пока LoreDub молчит, и приглушается ровно на время каждой озвученной
  реплики, — музыка и эффекты больше не сидят тихими весь вечер. Выключена она по умолчанию из-за
  оговорки: реплику, которую игра начнёт посреди озвучки, распознавание услышит приглушённой, и у
  тихой игры её может обрезать на полуслове.
