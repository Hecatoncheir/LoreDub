...
- В режиме субтитров дописанная реплика больше не озвучивается заново целиком. Если начало новой
  строки слово в слово повторяет хотя бы половину предыдущей — окно диалога допечатало фразу или
  добавило предложение, — звучат только слова с места, где тексты расходятся. Текст, полностью
